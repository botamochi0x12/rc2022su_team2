...
class CameraForTime
	...
	# 得点のカウントをTimeBoardオブジェクトにdelegate（移譲）する
	delegate draw_time: :@time_board, draw_sabotage: :@sabotage_board
